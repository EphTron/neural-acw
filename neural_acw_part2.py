...
def main():
    ...
    net1 = Network(sigmoid, 2, [20], 1)
    g1 = net1.train(250, data, 0.50, 0.001)
    net2 = Network(sigmoid, 2, [20], 1)
    g2 = net2.train(250, data, 0.50, 0.001)
    net3 = Network(sigmoid, 2, [20], 1)
    g3 = net3.train(250, data, 0.50, 0.001)
    g = average_graphs(g1, g2, g3)
    draw_graph(g, [2, 20, 1], 0.50, 0.001, 250)

    net_big_1 = Network(sigmoid, 2, [20], 1)
    gb_1 = net_big_1.train(250, data, 0.05, 0.001)
    net_big_2 = Network(sigmoid, 2, [20], 1)
    gb_2 = net_big_2.train(250, data, 0.05, 0.001)
    net_big_3 = Network(sigmoid, 2, [20], 1)
    gb_3 = net_big_3.train(250, data, 0.05, 0.001)
    g = average_graphs(gb_1, gb_2, gb_3)
    draw_graph(g, [2, 20, 1], 0.05, 0.001, 250)
    #
